package com.smallcode.springcloud.clinic.config;
...
@Configuration
@MapperScan(basePackages = "com.smallcode.springcloud.clinic.mapper", sqlSessionTemplateRef = "test1SqlSessionTemplate")
